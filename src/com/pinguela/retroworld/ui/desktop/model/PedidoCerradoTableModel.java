...
public class PedidoCerradoTableModel extends DefaultTableModel{
	public static final String[] COLUMN_NAMES = {"ID","Fecha","Usuario","Estado","Precio", "Detalle"};

	public PedidoCerradoTableModel(List<Pedido>pedidos) {
