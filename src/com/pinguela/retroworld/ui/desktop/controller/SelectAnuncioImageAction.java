...
public class SelectAnuncioImageAction extends BaseAction{

	private CreateAnuncioDialog dialog;

	public SelectAnuncioImageAction(CreateAnuncioDialog dialog) {
		this.dialog=dialog;
	}

	public SelectAnuncioImageAction(CreateAnuncioDialog dialog, String name) {
		super(name);
		this.dialog = dialog;
	}
	
	public SelectAnuncioImageAction(CreateAnuncioDialog dialog, String name, Icon icon) {
		super(name, icon);
		this.dialog = dialog;
	}
